...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      variables: resolve(__dirname, '../src/base/css/quasar.variables.styl'),
      slidetoggle: resolve(__dirname, '../src/base/css/karrot.slidetoggle.styl'),
      editbox: resolve(__dirname, '../src/base/css/karrot.editbox.styl'),
    },
    symlinks: false,
  },
  module: {
