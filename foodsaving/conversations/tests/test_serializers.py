...
from foodsaving.conversations.factories import Message, Conversation
from foodsaving.conversations.serializers import MessageSerializer, ConversationSerializer
