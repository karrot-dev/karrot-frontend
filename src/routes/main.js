...
const StorePickups = () => import('@/stores/pages/StorePickups')
const StoreFeedback = () => import('@/stores/pages/StoreFeedback')
const StoreHistory = () => import('@/stores/pages/StoreHistory')
