    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provenance', yunity.utils.models.MaxLengthCharField(max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', yunity.utils.models.MaxLengthCharField(max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basemodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='yunity.BaseModel')),
                ('status', yunity.utils.models.MaxLengthCharField(max_length=255)),
                ('type', yunity.utils.models.MaxLengthCharField(max_length=255)),
            ],
            bases=('yunity.basemodel',),
        ),
        migrations.CreateModel(
